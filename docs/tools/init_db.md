...
```
init:   created 29 tables, 0 already present    # fresh database
init:   created 1 table, 28 already present     # after a new table was added
verify: 29 tables checked, 0 differences
verify: 29 tables checked, 1 difference
